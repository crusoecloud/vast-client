...
**BundleInterval** | **int32** | Interval in seconds for periodic bundle | [optional] [default to null]
**LogEnabled** | **bool** | Enabled/disabled periodic log callhome | [optional] [default to null]
**LogInterval** | **int32** | Interval in seconds for periodic log | [optional] [default to null]
...
**CallhomeUploadDestination** | **string** | Callhome upload destination, Matar or Mars | [optional] [default to null]
...
**MaxUploadBandwidth** | **int32** | Maximum upload bandwidth in bytes | [optional] [default to null]
