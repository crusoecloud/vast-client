# CallhomeconfigsIdBody

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**BundleEnabled** | **bool** | Set to true to enable periodic sending of bundles to the Support server | [optional] [default to null]
**BundleInterval** | **int32** | The frequency in seconds for sending bundles to the Support server | [optional] [default to null]
**LogEnabled** | **bool** | Set to true to enable system state data to be logged to the Support server | [optional] [default to null]
**LogInterval** | **int32** | The frequency in seconds for sending system state data to the Support server. | [optional] [default to null]
**LunaOnAlarmEnabled** | **bool** | Enabled/disabled luna analyzing tool on specific alarms | [optional] [default to null]
**LunaOnAlarmInterval** | **int32** | Maximum allowed frequency in hours for alarm-triggered luna | [optional] [default to null]
**LunaAnalyzePeriod** | **int32** | Analyzed period size, minutes | [optional] [default to null]
...
**AwsS3BucketSubdir** | **string** | Sub-Directory in support bucket | [optional] [default to null]
**AwsS3Ak** | **string** | S3 Bucket access key | [optional] [default to null]
**AwsS3Sk** | **string** | S3 Bucket secret key | [optional] [default to null]
**AwsS3BucketName** | **string** | S3 Bucket for upload | [optional] [default to null]
...
**MaxUploadBandwidth** | **int32** | The maximum upload bandwidth in bytes. | [optional] [default to null]
