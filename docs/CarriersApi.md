...
[**ControlLed**](CarriersApi.md#ControlLed) | **Patch** /carriers/{id}/control_led/ | Control Slot LED
[**Highlight**](CarriersApi.md#Highlight) | **Patch** /carriers/{id}/highlight/ | This endpoint highlights the control Slot
 ...
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **id** | **string**| Slot ID | 
 **optional** | ***CarriersApiControlLedOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a CarriersApiControlLedOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
