...
**RemoteTargetId** | **int32** |  | [optional] [default to null]
**State** | **string** |  | [optional] [default to null]
**LoaneeSnapshotId** | **int32** |  | [optional] [default to null]
**RestoreTask** | **int32** |  | [optional] [default to null]
**Direction** | **string** |  | [optional] [default to null]
**SyncProgress** | **int32** |  | [optional] [default to null]
...
**Bw** | **int32** | BW | [optional] [default to null]
**LoaneeTenant** | [***GlobalSnapStreamLoaneeTenant**](GlobalSnapStream_loanee_tenant.md) |  | [optional] [default to null]
**ExternalState** | **string** | Global Snapshot Clone state | [optional] [default to null]
**OwnerTenant** | [***GlobalSnapStreamOwnerTenant**](GlobalSnapStream_owner_tenant.md) |  | [optional] [default to null]
