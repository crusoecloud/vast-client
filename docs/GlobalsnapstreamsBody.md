...
**LoaneeTenantId** | **int32** | Loanee tenant ID | [optional] [default to null]
**OwnerTenant** | [***interface{}**](interface{}.md) | Owner tenant details | [optional] [default to null]
