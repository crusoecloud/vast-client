...
**AbacReadOnlyValueName** | **string** |  | [optional] [default to null]
**AbacReadWriteValueName** | **string** |  | [optional] [default to null]
...
**ReverseLookup** | **bool** | resolve netgroups hostnames | [optional] [default to null]
**TlsCertificate** | **string** |  | [optional] [default to null]
**ActiveDirectory** | **string** |  | [optional] [default to null]
**ActiveDirectoryId** | **int32** |  | [optional] [default to null]
...
**UseLdaps** | **bool** | To activate LDAPS, auto discovery must turned on in the general tab | [optional] [default to null]
**IsVmsAuthProvider** | **bool** | Indicates whether this provider is used for VMS user authentication. You may select up to one Active Directory and one LDAP server for VMS user authentication. | [optional] [default to false]
