...
**Enable** | **bool** | Flag indicating the status of vast catalog config | [optional] [default to null]
**Splits** | **int32** | The number of splits used for query_data scanning speed | [optional] [default to null]
