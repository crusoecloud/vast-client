...
**SubnetCidr** | **int32** | The subnet expressed as a CIDR index (number of bits in each IP that belong to the subnet) | [default to null]
...
**Enabled** | **bool** | True for enable, False for disable | [optional] [default to true]
