...
**VmsPerfDebugMetricsEnabled** | **bool** | Enable VMS performance debug metrics | [optional] [default to null]
...
**PreferredCnodeIds** | **string** | List of preferred CNodes IDs (CSV) | [optional] [default to null]
**MinPwdLength** | **int32** | Minimum password length for new VMS managers | [optional] [default to null]
