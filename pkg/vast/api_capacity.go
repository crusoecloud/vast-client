 ...
 * @param optional nil or *CapacityApiCapacityQueryOpts - Optional Parameters:
     * @param "Path" (optional.String) - 
     * @param "Type_" (optional.String) - 
     * @param "TenantId" (optional.Int32) - 
@return CapacityData
*/

type CapacityApiCapacityQueryOpts struct {
    Path optional.String
    Type_ optional.String
    TenantId optional.Int32
}

func (a *CapacityApiService) CapacityQuery(ctx context.Context, localVarOptionals *CapacityApiCapacityQueryOpts) (CapacityData, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CapacityData
	)
