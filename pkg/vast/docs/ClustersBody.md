...
**CnodeIps** | **[]string** | The list of cnode ips, optional | [optional] [default to null]
**CnodeIpv6Pool** | **[]string** | The list of cnode ipv6 addresses, optional | [optional] [default to null]
**DnodeIps** | **[]string** | The list of D-Boxes | [optional] [default to null]
**DnodeIpv6Pool** | **[]string** | The list of dnode ipv6 addresses, optional | [optional] [default to null]
...
**SecondaryEkmAddress** | **string** | EKM address | [optional] [default to null]
**SecondaryEkmPort** | **int32** | EKM port | [optional] [default to null]
**EkmServers** | **string** | List of additional EKM servers: 10.0.0.1:5696,11.0.0.1:5697 | [optional] [default to null]
**EkmCertificate** | **string** | EKM certificate | [optional] [default to null]
**EkmPrivateKey** | **string** | EKM private key | [optional] [default to null]
**EkmCaCertificate** | **string** | EKM CA certificate | [optional] [default to null]
...
**DisableDboxesSlots** | **[]string** | List of dboxes slots to disable, optional | [optional] [default to null]
...
**RestrictUser** | **bool** | Flag for restrict vastdata user, default is False | [optional] [default to null]
**DisableRestrictUser** | **bool** | Ignore user restriction on raider clusters | [optional] [default to null]
**Vsettings** | [***map[string]string**](map.md) |  | [optional] [default to null]
**MockRaiderGuiAvailability** | **bool** | Creates mock for HPE Raider GUI availability, default is False | [optional] [default to null]
...
**Voc** | **bool** | vast on cloud installation flag (default is False) | [optional] [default to null]
