...
[**DboxesControlLed**](DboxesApi.md#DboxesControlLed) | **Patch** /dboxes/{id}/control_led/ | Control DBox LEDs
...
# **DboxesControlLed**
> AsyncTaskInResponse DboxesControlLed(ctx, id, optional)
Control DBox LEDs
 ...
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **id** | **string**| DBox ID | 
 **optional** | ***DboxesApiDboxesControlLedOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a DboxesApiDboxesControlLedOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
