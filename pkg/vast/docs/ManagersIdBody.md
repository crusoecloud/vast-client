...
**Roles** | **[]int32** | Specify all role IDs to update the roles assigned to the manager | [optional] [default to null]
...
**ObjectId** | **int32** | object ID | [optional] [default to null]
