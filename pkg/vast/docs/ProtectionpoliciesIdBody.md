...
**BigCatalog** | **bool** | Indicates if Protection Policy will be used for vast catalogue. There may only be 1 such policy. | [optional] [default to null]
