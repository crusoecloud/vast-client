...
**HubbleArgs** | **string** |  | [optional] [default to null]
**LunaArgs** | **string** |  | [optional] [default to null]
**AstronArgs** | **string** |  | [optional] [default to null]
**Preset** | **string** | A predefined preset bundle | [optional] [default to null]
**Traces** | **bool** |  | [optional] [default to null]
**ClusterId** | **int32** |  | [optional] [default to null]
**Core** | **string** |  | [optional] [default to null]
**Performance** | **bool** |  | [optional] [default to null]
**Platform** | **bool** |  | [optional] [default to null]
**Metrics** | **bool** |  | [optional] [default to null]
**MemTraces** | **bool** |  | [optional] [default to null]
**Callhome** | **bool** |  | [optional] [default to null]
**DnodesOnly** | **bool** |  | [optional] [default to null]
**CnodesOnly** | **bool** |  | [optional] [default to null]
