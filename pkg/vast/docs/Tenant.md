...
**NisTitle** | **string** |  | [optional] [default to null]
**AdTitle** | **string** |  | [optional] [default to null]
**LdapTitle** | **string** |  | [optional] [default to null]
**ClientIpRangesSummary** | **string** |  | [optional] [default to null]
...
**SmbAdministratorsGroupName** | **string** | Optional custom name to specify a non default privileged group. If not set, privileged group is the BUILTIN\\Administrators group. | [optional] [default to null]
...
**VippoolNames** | **[]string** | Array of VIP Pools that can be used with the tenant. | [optional] [default to null]
**PosixPrimaryProvider** | **string** | POSIX primary provider type | [optional] [default to null]
**LoginNamePrimaryProvider** | **string** | Login name primary provider type | [optional] [default to null]
...
**EncryptionGroup** | **string** | Tenant&#x27;s encryption group unique identifier | [optional] [default to null]
**EncryptionCrn** | **string** | Tenant&#x27;s encryption group unique identifier (deprecated) | [optional] [default to null]
**EncryptionGroupState** | **string** | Tenant&#x27;s encryption group state | [optional] [default to null]
**UseSmbNative** | **bool** | Access check decisions will be made based on user and group information from the Kerberos ticket. Use this if your Active Directory has a one-way trust. This is relevant for SMB only. | [optional] [default to null]
