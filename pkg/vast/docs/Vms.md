...
**SslKeyfile** | **string** |  | [optional] [default to null]
**SslPort** | **int32** |  | [optional] [default to null]
**Title** | **string** |  | [optional] [default to null]
**AutoLogoutTimeout** | **int32** |  | [optional] [default to null]
...
**TotalUsageCapacityPercentage** | **float64** | the remaining capacity out of the active capacity | [optional] [default to null]
**TotalActiveCapacity** | **float64** | sum of all active licenses capacity | [optional] [default to null]
**TotalRemainingCapacity** | **float64** | the total active capacity minus the system capacity | [optional] [default to null]
**CapacityUsable** | **bool** |  | [optional] [default to null]
