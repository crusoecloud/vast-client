...
type Vms struct {
	...
	TotalUsageCapacityPercentage float64 `json:"total_usage_capacity_percentage,omitempty"`
	// sum of all active licenses capacity
	TotalActiveCapacity float64 `json:"total_active_capacity,omitempty"`
	// the total active capacity minus the system capacity
	TotalRemainingCapacity float64 `json:"total_remaining_capacity,omitempty"`
